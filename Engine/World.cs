...
namespace Engine
{
    public static class World
    {
        ...
        {
            Items.Add(new Weapon(ITEM_ID_RUSTY_SWORD, "Rusty sword", "Rust swords", 0, 5));
        ...
        private static void PopulateLocations()
        {
            ...
            Location farmhouse = new Location(LOCATION_ID_FARMHOUSE, "Farmhouse", "There is small farmhouse, with a farmer in front.");
            farmhouse.QuestAvailableHere = QuestByID(QUEST_ID_CLEAR_FARMERS_FIELD);

            Location farmersField = new Location(LOCATION_ID_FARM_FIELD, "Farmer's Field", "You see a row of vegetables growing here.");
